        ...
        if ($customer->getDueDays() > 0) {
            ...
            if ($collectMandate !== null) {
                ...
                foreach ($collectMandateTags as $tag => $method) {
                    ...
                    // Make the text node for the method value
                    $node = $this->createTextNode((string) $this->getValueFromCallback([$collectMandate, $method]));
        ...
        if (!empty($banks)) {
            ...
            foreach ($banks as $bank) {
                ...
                foreach ($bankTags as $tag => $method) {
                    ...
                    // Make the text node for the method value
                    $node = $this->createTextNode((string) $bank->$method());
                ...
                $field2Node = $this->createTextNode((string) $bank->getAddressField2());
                $field3Node = $this->createTextNode((string) $bank->getAddressField3());
